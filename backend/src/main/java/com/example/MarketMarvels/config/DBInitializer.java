    ...
    CommandLineRunner initDatabase(CustomerRepository customerRepository) {
        return args -> {
            ...
            var customers = List.of(
                customerRepository.save(new Customer("Savings Accounts", "Our savings accounts offer a secure and convenient way to save money. With competitive interest rates and no monthly fees, you can watch your savings grow while having easy access to your funds when you need them.", "Savings Accounts", "(217) 555-7890, saving@bank.com")),
                ...
                customerRepository.save(new Customer("Investment Advisory Services", "Our investment advisory services provide personalized investment strategies tailored to your financial goals and risk tolerance. Our team of experienced advisors will help you navigate the complexities of the financial markets.", "Investment Advisory Services", "(305) 555-7891, invest@bank.com")),
                customerRepository.save(new Customer("Mortgage Loans", "Whether you're buying your first home or refinancing an existing mortgage, our mortgage loans offer competitive rates and flexible terms. Our mortgage specialists will guide you through the entire process.", "Mortgage Loans", "(650) 555-2345, loan@bank.com"))
            );
