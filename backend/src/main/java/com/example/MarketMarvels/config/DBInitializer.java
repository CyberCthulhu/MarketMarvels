    ...
    CommandLineRunner initDatabase(CustomerRepository customerRepository) {
        return args -> {
            ...
            var customers = List.of(
                customerRepository.save(new Customer("Savings Accounts", "Our savings accounts offer a secure and convenient way to save money. With competitive interest rates and no monthly fees, you can watch your savings grow while having easy access to your funds when you need them.", "Savings Accounts", "(217) 555-7890, saving@citi.com")),
